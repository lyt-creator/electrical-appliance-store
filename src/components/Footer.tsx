        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              <div className="w-10 h-10 bg-white rounded-full flex items-center justify-center">
                <span className="text-primary font-bold text-lg">电</span>
              </div>
              <span className="text-xl font-bold">电器商城</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/categories" className="text-gray-300 hover:text-white transition-colors">产品分类</a></li>
              <li><a href="/products" className="text-gray-300 hover:text-white transition-colors">全部产品</a></li>
              <li><a href="/admin" className="text-gray-300 hover:text-white transition-colors">管理员登录</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center space-x-3">
                ...
                <span className="text-gray-300">service@appliance.com</span>
              </li>
              <li className="flex items-start space-x-3">
                <MapPin className="w-5 h-5 mt-1" />
                <span className="text-gray-300">北京市朝阳区电器大厦</span>
              </li>
            </ul>
          </div>
        </div>
